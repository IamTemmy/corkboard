...
export function ListingCard({ listing }: { listing: Listing }) {
  return (
    <article className="group relative overflow-hidden rounded-[14px] border border-line bg-paper-soft shadow-[0_1px_2px_rgba(28,36,48,0.04)] transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(28,36,48,0.10)]">
