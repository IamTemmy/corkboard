...
export function SearchBar({ value, onChange }: SearchBarProps) {
  return (
    <form
      className="flex flex-1 rounded-[12px] border border-line bg-paper-soft p-1.5"
    ...
    >
      <input
        ...
        className="min-w-0 flex-1 bg-transparent px-4 py-3 text-[15px] outline-none placeholder:text-ink/40"
