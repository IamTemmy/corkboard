...
export const listings: Listing[] = [
  ...
  },
  {
    ...
    description:
      "Brown wool felt fedora with a grosgrain band. Clean, no dents. Fits most.",
    category: "Clothing",
    condition: "Like new",
    price: 20,
    images: ["/listings/felt-fedora.jpg"],
    seller: "Kwame",
    campus: "JSU",
    meetupSpot: "Student Center",
    contact: { instagram: "@kwame.fits" },
    status: "available",
    postedAt: "2026-08-06",
  },
  {
    id: "striped-jersey",
    title: "Golden Striped Soccer Jersey",
    description:
      "Pink-and-white striped soccer-style jersey with the 'Golden' graphic. Brand new, never worn.",
    category: "Clothing",
    condition: "Like new",
    price: 28,
    images: ["/listings/striped-jersey.jpg"],
    seller: "Lola",
    campus: "JSU",
    meetupSpot: "Student Plaza",
    contact: { instagram: "@lola.wears" },
    status: "available",
    postedAt: "2026-08-05",
  },
  {
    id: "grey-half-zip",
    title: "Ribbed Half-Zip Polo (Grey)",
    description: "Grey ribbed-knit half-zip polo, size XS. Brand new with tags.",
    category: "Clothing",
    condition: "Like new",
    price: 18,
    images: ["/listings/grey-half-zip.jpg"],
    seller: "Chris",
    campus: "JSU",
    meetupSpot: "Library",
    contact: { email: "chris@students.jsu.edu" },
    status: "available",
    postedAt: "2026-08-04",
  },
];
